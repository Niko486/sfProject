<template>
  <div style="width: 100%;padding: 10px;margin: 10px 0">
    <div style=";padding: 10px">
      <!--搜索区域-->
      <el-input v-model="queryInfo.query" placeholder="请输入书名" clearable style="width: 30%;"/>
      <el-button style="margin-left: 5px;"  @click="getUser">查询</el-button>
    </div>
    <el-table :data="tableData" stripe border style="width: 100%">
      <el-table-column prop="id" label="ID" sortable/>
      <el-table-column prop="username" label="书名" sortable/>
      <el-table-column prop="member" label="封面" sortable/>
      <el-table-column prop="points" label="作者" sortable/>
      <el-table-column prop="writer" label="字数" sortable/>
      <el-table-column prop="bookCounts" label="阅读量" sortable/>
    </el-table>
